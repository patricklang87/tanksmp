...
const StartScreen = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h1", { className: "title-card", children: "Tanks fer Nuffin'!" }), _jsx(IsTruthy, { value: selectedPage === 1, children: _jsx(StartOrJoin, { setSelectedPage: setSelectedPage, isError: isError, isSuccess: isSuccess, isLoading: isLoading, error: error, handleInitializeMatchClick: handleInitializeMatchClick }) }), _jsx(IsTruthy, { value: selectedPage === 3, children: _jsx(SubscribeMatch, { handleSubscribeMatchClick: handleSubscribeMatchClick, setGameId: setGameId, gameId: gameId, isGameCreator: isGameCreator }) }), _jsx(IsTruthy, { value: selectedPage === 4, children: _jsx(JoinMatch, { setGameId: setGameId, setPlayerName: setPlayerName, handleJoinMatchClick: handleJoinMatchClick, handleStartMatchClick: handleStartMatchClick, playerName: playerName, requestedColor: requestedColor, gameId: gameId, data: data, setRequestedColor: setRequestedColor, joinedMatch: joinedMatch, isGameCreator: isGameCreator }) })] }));
};
